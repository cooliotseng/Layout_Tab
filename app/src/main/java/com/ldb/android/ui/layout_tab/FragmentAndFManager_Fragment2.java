 ...
 */
public class FragmentAndFManager_Fragment2 extends Fragment {
    private static final String LOG_TAG = FragmentAndFManager_Fragment2.class.getSimpleName();
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        Log.d(LOG_TAG, "In onCreateView");
        View view = inflater.inflate(R.layout.fragment_fragmentmanager_tab2, null);
        return view;
    }
