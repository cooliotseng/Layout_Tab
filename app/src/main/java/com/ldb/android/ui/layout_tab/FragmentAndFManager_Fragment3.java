 ...
 */
public class FragmentAndFManager_Fragment3 extends Fragment {
    private static final String LOG_TAG = FragmentAndFManager_Fragment3.class.getSimpleName();
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        Log.d(LOG_TAG, "In onCreateView");
        View view = inflater.inflate(R.layout.fragment_fragmentmanager_tab3, null);
        return view;
    }
